...
void reportDistancesI2C(){
  ...
  long hcsr1 = hcsr1_distance * 1000;
  long hcsr2 = hcsr2_distance * 1000;
  long hcsr3 = hcsr3_distance * 1000;
  long hcsr4 = hcsr4_distance * 1000;
  long hcsr5 = hcsr5_distance * 1000;
  long hcsr6 = hcsr6_distance * 1000;
//  volatile byte* ptr_hcsr1_distance = (byte*) &hcsr1_distance;
//  volatile byte* ptr_hcsr2_distance = (byte*) &hcsr2_distance;
  volatile byte* ptr_hcsr1_distance = (byte*) &hcsr1;
  volatile byte* ptr_hcsr2_distance = (byte*) &hcsr2;
  volatile byte* ptr_hcsr3_distance = (byte*) &hcsr3;
  volatile byte* ptr_hcsr4_distance = (byte*) &hcsr4;
  volatile byte* ptr_hcsr5_distance = (byte*) &hcsr5;
  volatile byte* ptr_hcsr6_distance = (byte*) &hcsr6;
  Data[0] = ptr_pingnum[0];
  Data[1] = ptr_pingnum[1];
  Data[2] = ptr_pingnum[2];
  Data[3] = ptr_pingnum[3];
